...
if __name__ == "__main__":
    ...
    try:
        main()
        # Keep the completed scene visible for interactive inspection.
        # Automated tests retain the upstream exit behavior.
        if not args.test and not args.headless and simulation_app.is_running():
            app_utils.pause()
            print("Task completed. Scene paused; close the window to exit.")
